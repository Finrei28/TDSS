...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Tower Defense Simulator Strategies</title>
        <meta
          name="TDS Strategies - The Best Tower Defense Strategies"
          content="Find the best strategies for Tower Defense Simulator. Share your own strategies with the community to help others!"
        />
      </Head>
